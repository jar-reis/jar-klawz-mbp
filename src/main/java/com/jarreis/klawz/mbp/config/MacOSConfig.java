...
import io.jar.klawz.core.shell.ShellCommandExecutor;
import io.jar.klawz.core.shell.ShellSecurityPolicy;
...
public class MacOSConfig {
    ...
    /**
     * macOS gets the widest shell allowlist because the MBP is the
     * primary development / ops machine. All standard Unix tools plus
     * macOS-specific utilities are permitted.
     */
    @Bean
    public ShellSecurityPolicy macOSShellPolicy() {
        ...
        return new ShellSecurityPolicy(baseAllowlist, extraAllowlist);
    }
